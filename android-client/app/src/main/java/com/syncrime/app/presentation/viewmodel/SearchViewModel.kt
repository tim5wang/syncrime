...
class SearchViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun setQuery(query: String) {
        ...
        else _uiState.value = _uiState.value.copy(results = emptyList(), hasSearched = false)
    }
    ...
    fun search(query: String) {
        ...
        viewModelScope.launch {
            ...
            repository.searchRecords(query).catch { 
    ...
    fun clearSearch() { _uiState.value = SearchUiState() }
}
